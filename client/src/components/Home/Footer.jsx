        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              ...
              <li><Link to="/" className="hover:text-slate-900 transition-colors cursor-not-allowed opacity-50">Careers</Link></li>
              <li><Link to="/contact" className="hover:text-emerald-600 transition-colors">Contact</Link></li>
              <li><Link to="/" className="hover:text-slate-900 transition-colors cursor-not-allowed opacity-50">Press</Link></li>
            </ul>
          </div>
        </div>
