...
async function runFreshTest() {
    try {
        console.log('--- Fresh Start Verification Started ---');
        ...
        const cancelRes = await axios.put(`${BASE_URL}/api/bookings/${bookingId}/cancel`, { cancellationReason: 'Fresh Start Success' }, { headers: headers(userToken) });
